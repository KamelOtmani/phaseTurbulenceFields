...
template<class Type>
void Foam::functionObjects::phaseTurbulenceFields::processField
(
...
)
{
    ...
    const word localName(IOobject::scopedName(prefix_,  IOobject::groupName(fieldName,phaseName_)));
    Info << "Processing " << localName << "\n";
...
Foam::functionObjects::phaseTurbulenceFields::nuTilda
(
    const Model& model
) const
{
...
template<class Model>
Foam::tmp<Foam::volScalarField>
Foam::functionObjects::phaseTurbulenceFields::L
(
    const Model& model
) const
{
...
template<class Model>
Foam::tmp<Foam::volScalarField>
Foam::functionObjects::phaseTurbulenceFields::I
(
    const Model& model
) const
{
